...
import work.syonet.robohon.move.robohonmove.customize.ScenarioDefinitions;
import work.syonet.robohon.move.robohonmove.util.VoiceUIManagerUtil;
import work.syonet.robohon.move.robohonmove.util.VoiceUIVariableUtil.VoiceUIVariableListHelper;
...
public class MainActivity extends Activity implements MainActivityVoiceUIListener.MainActivityScenarioCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // あいさつボタンの実装
        Button GreetingButton = (Button) findViewById(R.id.greeting);
        GreetingButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (mVoiceUIManager != null) {
                    VoiceUIVariableListHelper helper = new VoiceUIVariableListHelper().addAccost(ScenarioDefinitions.ACC_GREETING);
                    VoiceUIManagerUtil.updateAppInfo(mVoiceUIManager, helper.getVariableList(), true);
                }
            }
        });
        ...
        HopeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mVoiceUIManager != null) {
                    VoiceUIVariableListHelper helper = new VoiceUIVariableListHelper().addAccost(ScenarioDefinitions.ACC_HOPE);
                    VoiceUIManagerUtil.updateAppInfo(mVoiceUIManager, helper.getVariableList(), true);
                }
            }
        });//ACC_OK_OR_NO
